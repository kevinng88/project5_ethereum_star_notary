...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Kev Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        if(ownerOf(_tokenId1) == msg.sender) {
            ...
            _transferFrom(msg.sender, ownerAddress1, _tokenId2);
            // _transferFrom(ownerAddress1, msg.sender, _tokenId1);
            _transferFrom(ownerAddress1, ownerAddress2, _tokenId1);
            // _transferFrom(ownerAddress2, ownerAddress1, _tokenId2);
        }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "You have to be owner to transfer Star");
